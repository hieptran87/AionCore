...
## [0.1.69](https://github.com/hieptran87/AionCore/compare/v0.1.68...v0.1.69) (2026-08-18)


### Features

* **acp,conversation:** elevate ACP protocol + assistant lineage logs to info ([#318](https://github.com/hieptran87/AionCore/issues/318)) ([fbcb299](https://github.com/hieptran87/AionCore/commit/fbcb29962da5ca4f52516663d592b57815875873))
* **acp:** client-hosted terminals — declare clientCapabilities.terminal and serve terminal/* ([#779](https://github.com/hieptran87/AionCore/issues/779)) ([c5fef5f](https://github.com/hieptran87/AionCore/commit/c5fef5f7ede02690c99bb97a7019a1b075cf939b))
* **acp:** use observed config options for preferences ([#468](https://github.com/hieptran87/AionCore/issues/468)) ([fd2d5c2](https://github.com/hieptran87/AionCore/commit/fd2d5c2db10e80dc478ee88c2d1f787e91015eb1))
* **agent:** add Antigravity (agy CLI) as a direct-CLI agent ([#741](https://github.com/hieptran87/AionCore/issues/741)) ([ddfd76b](https://github.com/hieptran87/AionCore/commit/ddfd76b9aa0e1192d02918f79490f1c4d06d343e))
* **agent:** classify structured agent send errors ([#356](https://github.com/hieptran87/AionCore/issues/356)) ([f52e8cd](https://github.com/hieptran87/AionCore/commit/f52e8cd93edb3e5edbee450ca41bef49e4cc9c48))
* **agent:** detect availability via session/new probe and assistant-first identity ([#500](https://github.com/hieptran87/AionCore/issues/500)) ([6c9a721](https://github.com/hieptran87/AionCore/commit/6c9a721fc4cf2b712f5c7b974f51b2935a0293b7))
* **agent:** multimodal prompt — native image/audio content blocks gated by promptCapabilities ([#774](https://github.com/hieptran87/AionCore/issues/774)) ([5a78a0b](https://github.com/hieptran87/AionCore/commit/5a78a0b2722edcce9f979d3f06c4461577f9e574))
* **agents:** add MiMo Code builtin ACP agent ([#700](https://github.com/hieptran87/AionCore/issues/700)) ([3a2d7e4](https://github.com/hieptran87/AionCore/commit/3a2d7e48386fd608b752354f032657c442b13e1b))
* **agents:** add omp (Oh My Pi) builtin ACP agent ([#717](https://github.com/hieptran87/AionCore/issues/717)) ([91f375d](https://github.com/hieptran87/AionCore/commit/91f375db0ba355c011309484382f4d5ab90ccbb2))
* **agents:** add Pi coding agent as builtin ACP agent ([#618](https://github.com/hieptran87/AionCore/issues/618)) ([0b9b3a8](https://github.com/hieptran87/AionCore/commit/0b9b3a882712f555e60fd33c027b604471df25c7))
* **agents:** sync ACP Registry integrations ([#637](https://github.com/hieptran87/AionCore/issues/637)) ([7d35e38](https://github.com/hieptran87/AionCore/commit/7d35e386969bb2dca58ca332adf00f9ae5bed6ce))
* **agent:** use aionrs runtime env API ([#586](https://github.com/hieptran87/AionCore/issues/586)) ([2f6f43f](https://github.com/hieptran87/AionCore/commit/2f6f43f305221701ca2baa58123180caf2342055))
* **ai-agent:** adapt to aionrs v0.2.2 config changes ([4f71bf2](https://github.com/hieptran87/AionCore/commit/4f71bf2c97de1bafc676906e26a5cf512ff94af9))
* **ai-agent:** route image attachments by model capability ([82c5bc1](https://github.com/hieptran87/AionCore/commit/82c5bc14bcb1fcf4396e033764732adbe63966ef))
* **ai-agent:** surface upstream 429 body in AgentSendError detail ([#591](https://github.com/hieptran87/AionCore/issues/591)) ([b8fe5b6](https://github.com/hieptran87/AionCore/commit/b8fe5b6f3c6f93f7b8fc730b658772da3f4f83fa))
* **ai-agent:** use responses api for gpt-5.6 ([cde4129](https://github.com/hieptran87/AionCore/commit/cde4129521340fe71e67a40f17f0d00a2935fe2a))
* **ai-agent:** use responses api for gpt-5.6 ([15bbb1e](https://github.com/hieptran87/AionCore/commit/15bbb1eeb97fa619bea14733958fc9623100a274))
* **aionrs:** consume attached files as structured content blocks ([0f8c7d1](https://github.com/hieptran87/AionCore/commit/0f8c7d1b681d35fdf55b857948978fc28444bf61))
* **aionrs:** inline image attachments for Aion CLI ([aff870b](https://github.com/hieptran87/AionCore/commit/aff870bb1d3328abfc3d0c24d8898f0e148790ab))
* **aionrs:** inline image attachments for Aion CLI ([e4e5e9b](https://github.com/hieptran87/AionCore/commit/e4e5e9b26867b59f8c66a11b1fc80abc0029b651))
* align team shared workspace resolution ([#475](https://github.com/hieptran87/AionCore/issues/475)) ([06b8e71](https://github.com/hieptran87/AionCore/commit/06b8e71572045ddac640bda38e2733dd9ad35f18))
* **assets:** update Kimi logo to official brand mark ([#646](https://github.com/hieptran87/AionCore/issues/646)) ([1c41b50](https://github.com/hieptran87/AionCore/commit/1c41b50d93b5cdb188792d9c6e794fb0e0a950a0))
* **assistant:** add built-in AionUi self-management assistant ([#474](https://github.com/hieptran87/AionCore/issues/474)) ([eea941e](https://github.com/hieptran87/AionCore/commit/eea941e344b9dd11338393078c63bddcc532137e))
* **assistant:** expand AionUi assistant into a butler with remote-access ([#481](https://github.com/hieptran87/AionCore/issues/481)) ([794c21a](https://github.com/hieptran87/AionCore/commit/794c21a589ef24de6f3fa03a628bb47e7958d6fe))
* **assistant:** persist thought-level defaults ([#574](https://github.com/hieptran87/AionCore/issues/574)) ([dd9f299](https://github.com/hieptran87/AionCore/commit/dd9f29967270f4e7263484532fad3b2199ba1894))
* **assistant:** 官方助手默认关闭 + 固定顺序 + 一次性重置迁移 ([#567](https://github.com/hieptran87/AionCore/issues/567)) ([3e30b02](https://github.com/hieptran87/AionCore/commit/3e30b02e021642ea116b68abc441bca0b91c60f3))
* bundle managed node and ACP runtime resources ([#403](https://github.com/hieptran87/AionCore/issues/403)) ([6aafd57](https://github.com/hieptran87/AionCore/commit/6aafd572178ff4197b7a356db48fea8250d50318))
* **channel:** add Discord Gateway plugin ([#813](https://github.com/hieptran87/AionCore/issues/813)) ([f711607](https://github.com/hieptran87/AionCore/commit/f71160760266f8f5507ff355e484b9f11bc336b0))
* **channel:** add PluginType::Zalo and Zalo credential fields ([fb01a77](https://github.com/hieptran87/AionCore/commit/fb01a77e24e4f0d94a6b3737799e43eccccb019a))
* **channel:** add Slack Socket Mode plugin ([#806](https://github.com/hieptran87/AionCore/issues/806)) ([ff887f1](https://github.com/hieptran87/AionCore/commit/ff887f1fd6ff787d59448a8353e4ac1d98f73081))
* **channel:** add zalo feature flag and zca-rs dependency ([a0c3329](https://github.com/hieptran87/AionCore/commit/a0c33296eb03d660d30f9fb2c0bd9e38652b3b6d))
* **channel:** add Zalo plugin type definitions and SSE events ([94c6b3b](https://github.com/hieptran87/AionCore/commit/94c6b3b694bba9a42a32878bad0b70bd2eef7ebb))
* **channel:** add ZaloApi client wrapper ([50548d7](https://github.com/hieptran87/AionCore/commit/50548d7ac1c2ccc13fb2d899516fb07ce326b7e1))
* **channel:** add zca-rs cookie and credential helper functions ([ed950b3](https://github.com/hieptran87/AionCore/commit/ed950b33b9d7b15475512417015e6c05285babe1))
* **channel:** implement ZaloPlugin lifecycle state machine and event listener ([668aa43](https://github.com/hieptran87/AionCore/commit/668aa43c82628b92390304b0679126e4eafb133b))
* **channel:** integrate ZaloApi into ZaloPlugin lifecycle and event listener ([a1e77f8](https://github.com/hieptran87/AionCore/commit/a1e77f8ae4920db5236cca414638a1bea7459e38))
* **channel:** update Zalo login SSE stream flow to match WeChat pattern ([510f31a](https://github.com/hieptran87/AionCore/commit/510f31ad28ff5e0d9b976658fab2f58b89311a81))
* **channel:** update ZaloApi to wrap zca::Api and real Zalo SDK login ([dba4f6f](https://github.com/hieptran87/AionCore/commit/dba4f6f4bb121057b22a1525c848c14a2d0b53f4))
* **channel:** wire real zca::Api listener and ZaloPlugin initialization ([0b77528](https://github.com/hieptran87/AionCore/commit/0b775281ac10923068911c7d0b2ef37a2cb740db))
* **channel:** wire real zca::Zalo login_qr callback to Zalo login SSE stream ([8dfa7cc](https://github.com/hieptran87/AionCore/commit/8dfa7cc32ff0119e9be18cbb561fd790d8f614cc))
* **claude:** label tool steps by what they do ([#870](https://github.com/hieptran87/AionCore/issues/870)) ([6757d0f](https://github.com/hieptran87/AionCore/commit/6757d0fdd2aec726e2be65b210176712972f56cb))
* **cli:** add agent-facing config and diagnose commands ([#595](https://github.com/hieptran87/AionCore/issues/595)) ([e80177e](https://github.com/hieptran87/AionCore/commit/e80177e95a380c89f833b4302ff24b7359ac2a58))
* **cli:** canonicalize CLI and bootstrap boundary errors ([#417](https://github.com/hieptran87/AionCore/issues/417)) ([9ddf82e](https://github.com/hieptran87/AionCore/commit/9ddf82e374f9f40fa5f7321fea54dca3a611f3c5))
* **codex:** auto-name sessions and label command steps ([#868](https://github.com/hieptran87/AionCore/issues/868)) ([7aedbbd](https://github.com/hieptran87/AionCore/commit/7aedbbdcaf2835f8675db8cea87381aed4a91f10))
* **config:** add conversation rename command ([#638](https://github.com/hieptran87/AionCore/issues/638)) ([a611553](https://github.com/hieptran87/AionCore/commit/a61155379ac031a161b210d4bdc297d009ba5a11))
* converge team mode runtime architecture ([#464](https://github.com/hieptran87/AionCore/issues/464)) ([abeb9a1](https://github.com/hieptran87/AionCore/commit/abeb9a184a280a8da1f9089a90f7be2db3c94af4))
* **conversation:** add cursor pagination for messages ([#515](https://github.com/hieptran87/AionCore/issues/515)) ([ba76273](https://github.com/hieptran87/AionCore/commit/ba7627328ae8447afb7566e90cbb556fa381dff0))
* **conversation:** agent-driven session auto-naming (ACP session_info_update + claude generate_session_title) ([#768](https://github.com/hieptran87/AionCore/issues/768)) ([c551c66](https://github.com/hieptran87/AionCore/commit/c551c6614270ba6bf045627a1598e71bbf77d63d))
* **conversation:** fork a conversation into a new one at a chosen message ([#772](https://github.com/hieptran87/AionCore/issues/772)) ([bb7c14e](https://github.com/hieptran87/AionCore/commit/bb7c14ef26f5af1157946841d12c5027c486cc21))
* **conversation:** mid-turn interjection — deliver messages while a turn is in flight ([#836](https://github.com/hieptran87/AionCore/issues/836)) ([484327d](https://github.com/hieptran87/AionCore/commit/484327dbbcd44ca8752c133dfe2fe04c901bafbb))
* **conversation:** support forking aionrs conversations ([6e04e74](https://github.com/hieptran87/AionCore/commit/6e04e741c42425072a8296fdacd95e5d1261d4d7))
* **conversation:** support forking aionrs conversations ([4b09341](https://github.com/hieptran87/AionCore/commit/4b0934145b46f208d75f63e14dfb190dd4fb06b8))
* **cron:** deduplicate and protect scheduled executions ([#601](https://github.com/hieptran87/AionCore/issues/601)) ([b189de0](https://github.com/hieptran87/AionCore/commit/b189de0e0a5a3cb837de8b0237ce6e7f96c8aa3d))
* **db:** dedicated startup stage for database created by a newer app (downgrade) ([#834](https://github.com/hieptran87/AionCore/issues/834)) ([db7ce9a](https://github.com/hieptran87/AionCore/commit/db7ce9ae2fe25081bd2485aae53bae665eb7ca10))
* **diagnostics:** expand feedback runtime evidence ([#612](https://github.com/hieptran87/AionCore/issues/612)) ([08426dc](https://github.com/hieptran87/AionCore/commit/08426dcf83290577a2b8ef706bc3c1d21354425c))
* enforce agent runtime policy and turn-aware state ([#436](https://github.com/hieptran87/AionCore/issues/436)) ([b7099fe](https://github.com/hieptran87/AionCore/commit/b7099fee0cd2488326957dfe7811bf87e15aabb7))
* enforce TeamRun ownership for agent turns ([#483](https://github.com/hieptran87/AionCore/issues/483)) ([4cc168a](https://github.com/hieptran87/AionCore/commit/4cc168a57c07879310d9e4fe8b8050735f35155a))
* **fs:** add /api/fs/reveal endpoint (resolve pe-ref + show in folder) ([#754](https://github.com/hieptran87/AionCore/issues/754)) ([f6977c7](https://github.com/hieptran87/AionCore/commit/f6977c784a7b508a5fc75f4c79977fd43ce22b4e))
* **fs:** add ChatFileRef content endpoints ([#757](https://github.com/hieptran87/AionCore/issues/757)) ([e8b6f4c](https://github.com/hieptran87/AionCore/commit/e8b6f4c825e04bc2c454ac75005d6f7f7642926d))
* **fs:** add copy-absolute-path endpoint that writes the clipboard server-side ([#803](https://github.com/hieptran87/AionCore/issues/803)) ([a621ed8](https://github.com/hieptran87/AionCore/commit/a621ed888c662bce2deaf16b30a9ccf8ab588804))
* **fs:** pdf stream endpoint + office ChatFileRef resolve + retire fs/resolve & WS fs/read ([#762](https://github.com/hieptran87/AionCore/issues/762)) ([e4e991a](https://github.com/hieptran87/AionCore/commit/e4e991afed637346e57578a3da48b6a3c62ce960))
* **idle:** extend idle-cleanup timeouts and make them env-configurable ([#643](https://github.com/hieptran87/AionCore/issues/643)) ([a719bc7](https://github.com/hieptran87/AionCore/commit/a719bc74a5587097246689c683079488fba73007))
* **mcp:** support session scoped MCP injection ([#363](https://github.com/hieptran87/AionCore/issues/363)) ([2974f47](https://github.com/hieptran87/AionCore/commit/2974f47346056ef5483fe3e9c39d58d63f714ae7))
* multi-account user scope isolation ([#669](https://github.com/hieptran87/AionCore/issues/669)) ([7f8ed6c](https://github.com/hieptran87/AionCore/commit/7f8ed6c5d5a899984e23b1ae130640bdeaffd6dc))
* **preview:** backend half of preview v2 — office refresh, overflow marker, content-change signal ([#780](https://github.com/hieptran87/AionCore/issues/780)) ([eb4bd7f](https://github.com/hieptran87/AionCore/commit/eb4bd7f78219fcb0bc50c52affb456a19b04bed1))
* **project:** add project-bind foundation (db + aionui-project) ([#672](https://github.com/hieptran87/AionCore/issues/672)) ([70eae04](https://github.com/hieptran87/AionCore/commit/70eae0465259c4a4ca1db44a1a456b0040d1d24f))
* **project:** fs/search filename search vertical ([#720](https://github.com/hieptran87/AionCore/issues/720)) ([b64ab4f](https://github.com/hieptran87/AionCore/commit/b64ab4fd6eef74812360d2a901aa39d8c946c033))
* **project:** hide OS-junk and VCS-internal noise from listings ([#727](https://github.com/hieptran87/AionCore/issues/727)) ([6197117](https://github.com/hieptran87/AionCore/commit/6197117ef09bc0797f5656d3d6c3ec2e40161c09))
* **project:** Project Explorer backend (runtime, WS monitor, HTTP) ([#701](https://github.com/hieptran87/AionCore/issues/701)) ([0a79100](https://github.com/hieptran87/AionCore/commit/0a791002b0b43f0ac883a4b58b76336830041da0))
* **project:** wire project-bind side branch into owner creation ([#676](https://github.com/hieptran87/AionCore/issues/676)) ([300c833](https://github.com/hieptran87/AionCore/commit/300c8339af25807913eec921b0221cf51e1db145))
* **provider:** add per-model capability settings ([0f60d7e](https://github.com/hieptran87/AionCore/commit/0f60d7edda96f3a3a43d27765a8e800f53c6d294))
* **provider:** add per-model capability settings ([ba3e9ff](https://github.com/hieptran87/AionCore/commit/ba3e9ff1a893bf7111173b8e9301a0c2f140a2c1))
* remove single-chat team upgrade path ([#524](https://github.com/hieptran87/AionCore/issues/524)) ([5c60df3](https://github.com/hieptran87/AionCore/commit/5c60df38473b5a566e4f3598f6a36dfb63f52bab))
* **scm:** live repository-set changes + pe_name ([#790](https://github.com/hieptran87/AionCore/issues/790)) ([81ef258](https://github.com/hieptran87/AionCore/commit/81ef258913e6ac5076a86d4adcc7edcc0f8f21ef))
* **scm:** one-level repository discovery for workspace roots ([#800](https://github.com/hieptran87/AionCore/issues/800)) ([3d0e276](https://github.com/hieptran87/AionCore/commit/3d0e276078fe95180c9267bdbde548096459becb))
* **scripts:** carry aionrs changelog into the bump PR ([#703](https://github.com/hieptran87/AionCore/issues/703)) ([f34cfb6](https://github.com/hieptran87/AionCore/commit/f34cfb61ba58266dfe8100cebc678925c9d67806))
* **session-port:** route claude/codex through the direct-CLI SessionAgentTask ([#609](https://github.com/hieptran87/AionCore/issues/609)) ([14efff8](https://github.com/hieptran87/AionCore/commit/14efff85f192e0d1a588584fea3a870347661de7))
* **session:** AskUserQuestion as a first-class capability (own event, command, counter and endpoint) ([#778](https://github.com/hieptran87/AionCore/issues/778)) ([f9cf506](https://github.com/hieptran87/AionCore/commit/f9cf506d5755d0ae8d6a4e9e28fea5cdd3880bce))
* **session:** make background work visible — live progress cards and out-of-turn delivery ([#758](https://github.com/hieptran87/AionCore/issues/758)) ([f0422ca](https://github.com/hieptran87/AionCore/commit/f0422ca28b08b3e16e8e8e2dd1778e816694095e))
* **session:** report a deferred mode switch as pending instead of observed ([#846](https://github.com/hieptran87/AionCore/issues/846)) ([9700f88](https://github.com/hieptran87/AionCore/commit/9700f88306aa9c2d51d257e865866253db002bd6))
* **sidebar:** add user_order ordering base and sidebar grouping API ([#820](https://github.com/hieptran87/AionCore/issues/820)) ([d2f9f8c](https://github.com/hieptran87/AionCore/commit/d2f9f8ce9e8793a350835fdf36f2973f3cc95b3d))
* **stt:** streaming transcription proxy over websocket ([#455](https://github.com/hieptran87/AionCore/issues/455)) ([1c19a8b](https://github.com/hieptran87/AionCore/commit/1c19a8b9a80be665d30310071c0c12bc95881c11))
* **system:** add feedback diagnostics report ([#585](https://github.com/hieptran87/AionCore/issues/585)) ([a3eb1e4](https://github.com/hieptran87/AionCore/commit/a3eb1e49396e715ce8464700dca5e50a966552ee))
* **team:** add CLI fallback collaboration transport ([#629](https://github.com/hieptran87/AionCore/issues/629)) ([bbb6fec](https://github.com/hieptran87/AionCore/commit/bbb6fec08f7fd818375664bc5bf206805013f7d0))
* **team:** add read-only mailbox/task activity API and real-time events ([#740](https://github.com/hieptran87/AionCore/issues/740)) ([f86c053](https://github.com/hieptran87/AionCore/commit/f86c053eded3e04f5139dadeb3bdb9bae94c9c3b))
* **team:** add run state snapshot endpoint ([#549](https://github.com/hieptran87/AionCore/issues/549)) ([2c7cfe8](https://github.com/hieptran87/AionCore/commit/2c7cfe8a3eb49c8be790a7733ccad2f8a49f19bd))
* **team:** centralize team MCP prompt governance ([#490](https://github.com/hieptran87/AionCore/issues/490)) ([5485a95](https://github.com/hieptran87/AionCore/commit/5485a95897c327dc2c8f4f1c44cfab7c6f628905))
* **team:** leader-only warmup with lazy teammate wakeup and per-member attach ([#670](https://github.com/hieptran87/AionCore/issues/670)) ([f542da8](https://github.com/hieptran87/AionCore/commit/f542da83bf7387dc8525df561eda9f43f2c5ac34))
* **team:** support queued team_send_message semantics ([#479](https://github.com/hieptran87/AionCore/issues/479)) ([a57a079](https://github.com/hieptran87/AionCore/commit/a57a079136cbe8a5fafa0ff4d8660bbfa28a07c5))
* **team:** support slot-scoped team pause and wake flow ([#472](https://github.com/hieptran87/AionCore/issues/472)) ([398b20f](https://github.com/hieptran87/AionCore/commit/398b20f2279fc7b042ae65cbbe5658be953e6f31))
* **team:** team mode reliability improvements, model switch persistence and runtime restart ([#787](https://github.com/hieptran87/AionCore/issues/787)) ([e9b6f13](https://github.com/hieptran87/AionCore/commit/e9b6f13983cc787bbc329b0e2d98cd89e157b76a))
* **zalo:** implement send_message for text and image via zca_rs SDK ([9411e9f](https://github.com/hieptran87/AionCore/commit/9411e9fddd49b3dc34b3164e0320fc0e69b55bdd))
* **zalo:** update start_zalo_listener using zca_rs websocket listener ([84f630d](https://github.com/hieptran87/AionCore/commit/84f630ddd0632ed114253ce3e35eff2ecc834345))


### Bug Fixes

* **acp:** bound config RPC timeout and release lease without tearing down connection ([#654](https://github.com/hieptran87/AionCore/issues/654)) ([c9a0051](https://github.com/hieptran87/AionCore/commit/c9a005163df4dfef48bdbdd01f67be04cae120dd))
* **acp:** confirm legacy mode/model on ACK instead of awaiting observed update ([#635](https://github.com/hieptran87/AionCore/issues/635)) ([ded7a5c](https://github.com/hieptran87/AionCore/commit/ded7a5ce7951cad942852488f30382ed7fb909da))
* **acp:** give a first-run npx agent room to install before initialize times out ([#854](https://github.com/hieptran87/AionCore/issues/854)) ([f6131a4](https://github.com/hieptran87/AionCore/commit/f6131a4ace14c90946de009ec8315f1c37f44e0f))
* **acp:** harden grok startup environment and npx recovery ([#662](https://github.com/hieptran87/AionCore/issues/662)) ([10cdd57](https://github.com/hieptran87/AionCore/commit/10cdd579849e6430c360cc88b25896ff8c146490))
* **acp:** load user MCP servers and emit empty-finish diagnostic (ELECTRON-1JG) ([#327](https://github.com/hieptran87/AionCore/issues/327)) ([2a6c2e9](https://github.com/hieptran87/AionCore/commit/2a6c2e943683a72eebaaa1d608be10fe5f795634))
* **acp:** normalize Codex full-access mode ([#608](https://github.com/hieptran87/AionCore/issues/608)) ([df51fcf](https://github.com/hieptran87/AionCore/commit/df51fcf77aa541c78c6eb6af4e987eab92b1ff07))
* **acp:** persist runtime model and mode into assistant preferences ([#482](https://github.com/hieptran87/AionCore/issues/482)) ([b9bcad9](https://github.com/hieptran87/AionCore/commit/b9bcad9d2deb94281a084c4b43a9f09c477444ed))
* **acp:** prefer config options catalogs ([#425](https://github.com/hieptran87/AionCore/issues/425)) ([9d89cc9](https://github.com/hieptran87/AionCore/commit/9d89cc9b46cc684a04c2cb9452ed9d792bd3a8de))
* **acp:** preserve confirmed model selection ([#437](https://github.com/hieptran87/AionCore/issues/437)) ([e16e11f](https://github.com/hieptran87/AionCore/commit/e16e11fa1e6ff9bd6449a8b1bc6bcfb5859fc865))
* **acp:** preserve selectors for partial config snapshots ([#548](https://github.com/hieptran87/AionCore/issues/548)) ([0cb3a9a](https://github.com/hieptran87/AionCore/commit/0cb3a9a5925b273ec1b6610c04469f8724ad14fb))
* **acp:** recover dead ACP connections ([#487](https://github.com/hieptran87/AionCore/issues/487)) ([8264873](https://github.com/hieptran87/AionCore/commit/8264873c3879a199201d3700a9f7a9a7b7ba1534))
* **acp:** stabilize mode and model source of truth ([#409](https://github.com/hieptran87/AionCore/issues/409)) ([300bb1e](https://github.com/hieptran87/AionCore/commit/300bb1eba0c30207918dc9b23a2934f3542d2fe4))
* **acp:** stop collapsing agent failures into an opaque -32603 ([#869](https://github.com/hieptran87/AionCore/issues/869)) ([27fc006](https://github.com/hieptran87/AionCore/commit/27fc006a9811bdb55153741cfb549ad1b42c3751))
* **acp:** tolerate CodeBuddy dialect and stop misreporting empty turns as needs-auth ([#692](https://github.com/hieptran87/AionCore/issues/692)) ([572f3c1](https://github.com/hieptran87/AionCore/commit/572f3c10e1cd183c5dd759d1e10adff55655d6c9))
* **acp:** track close reason to avoid reporting user cancel as crash (ELECTRON-1K0) ([#328](https://github.com/hieptran87/AionCore/issues/328)) ([9506f9d](https://github.com/hieptran87/AionCore/commit/9506f9d1666e26b8659e3339dbfa8f13568f54ce))
* **adoption:** move legacy root assistant-rules to the adopter ([#788](https://github.com/hieptran87/AionCore/issues/788)) ([0b678e8](https://github.com/hieptran87/AionCore/commit/0b678e8a6812bd9c734a8c825fb2c6fca6079661))
* **agent:** adapt aionrs compat API ([#528](https://github.com/hieptran87/AionCore/issues/528)) ([f4ad432](https://github.com/hieptran87/AionCore/commit/f4ad4326342c7c93abaa1da121683d472028c2f5))
* **agent:** add provider health check probe ([#358](https://github.com/hieptran87/AionCore/issues/358)) ([d3a8702](https://github.com/hieptran87/AionCore/commit/d3a8702c2c98a78085a24860bb20a15b1682dfda))
* **agent:** align unchecked availability with team runtime selection ([#571](https://github.com/hieptran87/AionCore/issues/571)) ([f80b0ce](https://github.com/hieptran87/AionCore/commit/f80b0ceac3b603c3b58e0f1a25feb31a0261f7c8))
* **agent:** avoid full availability refresh on reads ([#566](https://github.com/hieptran87/AionCore/issues/566)) ([1ffb7aa](https://github.com/hieptran87/AionCore/commit/1ffb7aa6a0fcb55a4c8966b965133ab0ace9e8b2))
* **agent:** classify ACP and provider errors ([#518](https://github.com/hieptran87/AionCore/issues/518)) ([ef573d0](https://github.com/hieptran87/AionCore/commit/ef573d0071acc0c9f4671da8a4029abea8ec2a57))
* **agent:** classify Bedrock 'model identifier is invalid' as model-not-found (AIO-12) ([#377](https://github.com/hieptran87/AionCore/issues/377)) ([07dc3ac](https://github.com/hieptran87/AionCore/commit/07dc3ac8b2fae8962e8a7e31a223875669e11ba1))
* **agent:** expose aionrs mode config option ([#501](https://github.com/hieptran87/AionCore/issues/501)) ([d1a360d](https://github.com/hieptran87/AionCore/commit/d1a360de17114dad5e1834ab2fc8531672ffd17b))
* **agent:** expose runtime catalogs from metadata ([#523](https://github.com/hieptran87/AionCore/issues/523)) ([d9c2502](https://github.com/hieptran87/AionCore/commit/d9c2502e499a6794476fcdbe63a14573b4fa81d0))
* **agent:** guard internal Aion CLI command overrides ([#538](https://github.com/hieptran87/AionCore/issues/538)) ([f141233](https://github.com/hieptran87/AionCore/commit/f141233b0cbe03a8f8ae61372d2a8fdabb9cb81c))
* **agent:** keep the thought-level picker on a resumed conversation ([#763](https://github.com/hieptran87/AionCore/issues/763)) ([dcf015e](https://github.com/hieptran87/AionCore/commit/dcf015eda00a1a5fe3952fc7eaa1c3236a5b8e9b))
* **agent:** make codex sandbox sync non-fatal ([#370](https://github.com/hieptran87/AionCore/issues/370)) ([8916faa](https://github.com/hieptran87/AionCore/commit/8916faa9bc69ff1959aef2db83febb7c03f1441b))
* **agent:** preserve ACP error cause detail ([#581](https://github.com/hieptran87/AionCore/issues/581)) ([220f682](https://github.com/hieptran87/AionCore/commit/220f6823c1d29fde640427cfdd77de7e981758b2))
* **agent:** preserve process-group cleanup after leader exit ([#369](https://github.com/hieptran87/AionCore/issues/369)) ([73d4fb4](https://github.com/hieptran87/AionCore/commit/73d4fb4f4e4647352ba3dcac07e4a6b277e46c7b))
* **agent:** project available commands in management rows ([#579](https://github.com/hieptran87/AionCore/issues/579)) ([689ee8f](https://github.com/hieptran87/AionCore/commit/689ee8f91cbabd7e57c4e882f86c1ceec167e36d))
* **agent:** reflect auth failures from real turns into agent availability ([#655](https://github.com/hieptran87/AionCore/issues/655)) ([769eecb](https://github.com/hieptran87/AionCore/commit/769eecb761b3c5ee3f5cb055e972168aeea014d5))
* **agent:** reject and clear launch-path override for npx-bridged agents ([#651](https://github.com/hieptran87/AionCore/issues/651)) ([0724757](https://github.com/hieptran87/AionCore/commit/07247577c3be21b7e0aa39ead24e3afddbd13c2e))
* **agent:** send non-empty clientInfo in ACP initialize handshake ([#471](https://github.com/hieptran87/AionCore/issues/471)) ([5a8df22](https://github.com/hieptran87/AionCore/commit/5a8df22fd9db4b77ec0c7e9870aec78db6d7bec7))
* **agents:** honor login PATH and validate builtin CLIs ([#622](https://github.com/hieptran87/AionCore/issues/622)) ([3190be1](https://github.com/hieptran87/AionCore/commit/3190be1fae7e15be98f5f963e57a54fdee87029e))
* **agents:** launch omp through its local CLI instead of the npx bridge ([#855](https://github.com/hieptran87/AionCore/issues/855)) ([13b5dd4](https://github.com/hieptran87/AionCore/commit/13b5dd42f941e9dd8a9f3ff06498a3df4449452f))
* **agents:** persist the catalog the availability probe already fetched ([#735](https://github.com/hieptran87/AionCore/issues/735)) ([2438095](https://github.com/hieptran87/AionCore/commit/24380952e133b38b2f0192d2be09bda1f5306d5a))
* **agent:** stop the idle scanner from killing agents with live background tasks ([#811](https://github.com/hieptran87/AionCore/issues/811)) ([50b6570](https://github.com/hieptran87/AionCore/commit/50b6570b95b69564037ee89901c8709f889f60b7))
* **agent:** support aionrs 0.1.31 ([#503](https://github.com/hieptran87/AionCore/issues/503)) ([d612602](https://github.com/hieptran87/AionCore/commit/d612602aa3bfa88bef60a85a1aa5cb40634055fd))
* **agent:** surface OpenClaw Gateway unreachable errors ([#498](https://github.com/hieptran87/AionCore/issues/498)) ([90d34ae](https://github.com/hieptran87/AionCore/commit/90d34aee81d484c949b3fc4358447095752e2b8d))
* **agent:** surface sign-in hint on empty ACP turns from auth-gated agents ([#653](https://github.com/hieptran87/AionCore/issues/653)) ([7a8c26e](https://github.com/hieptran87/AionCore/commit/7a8c26e31509a3794e272596e0c100168de65c7b))
* **agent:** tighten send_error classifier (AIO-87, AIO-89, AIO-90) ([#375](https://github.com/hieptran87/AionCore/issues/375)) ([d9a2f76](https://github.com/hieptran87/AionCore/commit/d9a2f763d14ec642c09f3aef5a2d8b716f4b0648))
* **agent:** unify CLI probe pipeline with classified failures and adaptive slow-probe recheck ([#678](https://github.com/hieptran87/AionCore/issues/678)) ([67945d2](https://github.com/hieptran87/AionCore/commit/67945d2708c8829d99f6ab4aa92cd73bc51b2bcc))
* **agent:** validate managed ACP platform binaries ([#462](https://github.com/hieptran87/AionCore/issues/462)) ([651c79f](https://github.com/hieptran87/AionCore/commit/651c79f0ec0e07009f637ebb2afa14de47c95ba3))
* **agent:** wait for task shutdown during clear ([#446](https://github.com/hieptran87/AionCore/issues/446)) ([bea814e](https://github.com/hieptran87/AionCore/commit/bea814e08ddb96ccb5d09a8016e92d179a2f318a))
* **ai-agent:** auto approve team mcp permissions ([#447](https://github.com/hieptran87/AionCore/issues/447)) ([096953e](https://github.com/hieptran87/AionCore/commit/096953e038aaa1f07333bbd6751ee927bf129e60))
* **ai-agent:** cap provider health check tokens ([1021b63](https://github.com/hieptran87/AionCore/commit/1021b631aa1b7b97d7b70d18284df21bf29dda41))
* **ai-agent:** degrade corrupt process registry, atomic writes, and startup-failure child cleanup ([#784](https://github.com/hieptran87/AionCore/issues/784)) ([812af0b](https://github.com/hieptran87/AionCore/commit/812af0b96143f0afb80f9d638033467b05c5b2ff))
* **ai-agent:** enable official kimi k2.7 code image input ([c4b2795](https://github.com/hieptran87/AionCore/commit/c4b279583a0bf1d127d867a1d403a1f195bbed91))
* **ai-agent:** enable official kimi k2.7 code image input ([4bff331](https://github.com/hieptran87/AionCore/commit/4bff3311231e9b526a5ad27ddc74b200a8b83b3d))
* **ai-agent:** ignore max token limits for aionui requests ([0121c24](https://github.com/hieptran87/AionCore/commit/0121c24d70f4a5a63e79ee71869aee34e6b62506))
* **ai-agent:** ignore max token limits for aionui requests ([8bdf305](https://github.com/hieptran87/AionCore/commit/8bdf305e9a94d1a5aa8402424e8ef8d540eeb66c))
* **ai-agent:** pin image-capable aionrs revision ([6687805](https://github.com/hieptran87/AionCore/commit/6687805f09042b9a34b4e5ac22900374358d2671))
* **ai-agent:** rebuild ACP session when CLI rejects stale sid (ELECTRON-1HQ) ([#320](https://github.com/hieptran87/AionCore/issues/320)) ([b4d8a75](https://github.com/hieptran87/AionCore/commit/b4d8a7505e78c48ed26af364b6e13ad4302b4727))
* **ai-agent:** resolve cron full-auto mode to backend-native YOLO (ELECTRON-3RQ) ([#699](https://github.com/hieptran87/AionCore/issues/699)) ([0b06fb5](https://github.com/hieptran87/AionCore/commit/0b06fb582a4c2eff7827909b65a86e984a1f94cf))
* **ai-agent:** set default aionrs thinking cli args ([de240a4](https://github.com/hieptran87/AionCore/commit/de240a4435058bf349acd7897b2836cff49b884d))
* **ai-agent:** token usage for the direct-CLI backends (claude / codex) ([#733](https://github.com/hieptran87/AionCore/issues/733)) ([93a24f4](https://github.com/hieptran87/AionCore/commit/93a24f43fcd0f1ecc4528b690d34ba83153f4834))
* **ai-agent:** trim stderr buffer at UTF-8 char boundary ([#443](https://github.com/hieptran87/AionCore/issues/443)) ([7380c7c](https://github.com/hieptran87/AionCore/commit/7380c7cdd3c08a51de397e6af32f22361199b592))
* **aionrs:** adapt runtime guard config ([#510](https://github.com/hieptran87/AionCore/issues/510)) ([464f453](https://github.com/hieptran87/AionCore/commit/464f4533822c8959a4d0f4d4d81d2b998152498e))
* **aionrs:** classify engine errors structurally ([#494](https://github.com/hieptran87/AionCore/issues/494)) ([8552b0a](https://github.com/hieptran87/AionCore/commit/8552b0a30f0eb323d62032986919170c05374c6a))
* **aionrs:** default missing model protocol to openai ([be519dc](https://github.com/hieptran87/AionCore/commit/be519dcc73af8e274c8d6d7e06fa103cdd115eae))
* **aionrs:** drop malformed tool-call events ([#486](https://github.com/hieptran87/AionCore/issues/486)) ([67ffbd0](https://github.com/hieptran87/AionCore/commit/67ffbd03d3aa17a46b47d6eafe08277edaaacdc4))
* **aionrs:** drop orphaned tool_call history on session resume (ELECTRON-1HV, ELECTRON-1J6) ([#330](https://github.com/hieptran87/AionCore/issues/330)) ([880722f](https://github.com/hieptran87/AionCore/commit/880722fd3b2f4e37fa5654cc5ed210cddbfd14b5))
* **aionrs:** preserve tool call correlation across aborts ([#335](https://github.com/hieptran87/AionCore/issues/335)) ([d65c8ed](https://github.com/hieptran87/AionCore/commit/d65c8ed49be4a558aff99e907e359264d6729d1c))
* **aionrs:** respect model protocol over base url ([10f3ce9](https://github.com/hieptran87/AionCore/commit/10f3ce97b569894d6e29edab9c661b9869198ef4))
* **aionrs:** stop inferring anthropic v1 suffix ([ed8f26c](https://github.com/hieptran87/AionCore/commit/ed8f26c6a1e9474984602712349e0ad2961108c4))
* **aionrs:** use versioned anthropic path for custom providers ([e300395](https://github.com/hieptran87/AionCore/commit/e30039568edda6619dbf8da99c56d23157ca031c))
* **aionui-ai-agent:** classify aionrs API connection errors ([#389](https://github.com/hieptran87/AionCore/issues/389)) ([c3f16f7](https://github.com/hieptran87/AionCore/commit/c3f16f7453d061d0865cb7c61eca183a6d6e797f))
* **aionui-ai-agent:** strip HTML body from sanitized error detail (AIO-13) ([#380](https://github.com/hieptran87/AionCore/issues/380)) ([9fc5d8c](https://github.com/hieptran87/AionCore/commit/9fc5d8c088c644f771457bf50658ac7c6e98c1dc))
* **antigravity:** drop the 'default' UI placeholder model while discovery is empty ([#785](https://github.com/hieptran87/AionCore/issues/785)) ([18617b3](https://github.com/hieptran87/AionCore/commit/18617b387c8797eaefa2b9438344442b8ff8e66e))
* **antigravity:** parse TSV output from `agy models` ([#797](https://github.com/hieptran87/AionCore/issues/797)) ([240e7f4](https://github.com/hieptran87/AionCore/commit/240e7f45f91584474f818e306f3d2186e74aced1))
* **antigravity:** read the HTTP status before parsing the hook decision ([#867](https://github.com/hieptran87/AionCore/issues/867)) ([60bab79](https://github.com/hieptran87/AionCore/commit/60bab79d4a10844fb2dc4397cd89c2da09a6548d))
* **app:** bind backend before startup services ([#397](https://github.com/hieptran87/AionCore/issues/397)) ([1ae944c](https://github.com/hieptran87/AionCore/commit/1ae944cb4239e898f910118885df9dfa793aec54))
* **app:** reuse conversation service for channel messages ([#531](https://github.com/hieptran87/AionCore/issues/531)) ([dce8053](https://github.com/hieptran87/AionCore/commit/dce80538b1575a35e512f93b6da0a5b2ab7b89c4))
* **app:** stop backend when desktop exits ([#433](https://github.com/hieptran87/AionCore/issues/433)) ([d300235](https://github.com/hieptran87/AionCore/commit/d30023562bcb6d413f428fcb1dec412929a72ab3))
* **app:** use process synchronize access for parent watcher ([#438](https://github.com/hieptran87/AionCore/issues/438)) ([95571f1](https://github.com/hieptran87/AionCore/commit/95571f1c9fcd69df6ec15d8f595178c4869c15d0))
* **assistant:** canonicalize rule file storage ([#625](https://github.com/hieptran87/AionCore/issues/625)) ([020a27a](https://github.com/hieptran87/AionCore/commit/020a27a77aeb2b5be7a2b4380aab8ae2686311c4))
* **assistant:** default agent_type to aionrs and resolve by provider (ELECTRON-1J1, ELECTRON-1KV) ([#325](https://github.com/hieptran87/AionCore/issues/325)) ([5c7fa04](https://github.com/hieptran87/AionCore/commit/5c7fa04bef47cf5bf2ea6badc66f723f0aafe1ec))
* **assistant:** expose auto-inject skills and preserve assistant rules ([#525](https://github.com/hieptran87/AionCore/issues/525)) ([f2e91fd](https://github.com/hieptran87/AionCore/commit/f2e91fde95ef3a84e43fbe22d71960d64686d3b0))
* **assistant:** filter generated assistants by installed agents ([#578](https://github.com/hieptran87/AionCore/issues/578)) ([5b7c366](https://github.com/hieptran87/AionCore/commit/5b7c366132006eb16e748e8fc5a0976da9a5b2a3))
* **assistant:** normalize avatar storage and identity ([#558](https://github.com/hieptran87/AionCore/issues/558)) ([155c278](https://github.com/hieptran87/AionCore/commit/155c278b7b603e8bf29e412295cec5ec50bb25fe))
* **assistant:** preserve builtin override selections ([#535](https://github.com/hieptran87/AionCore/issues/535)) ([be4a81e](https://github.com/hieptran87/AionCore/commit/be4a81ef2927c0bedef3dbf22a69fc4e8f2ffd40))
* **assistant:** remove star office helper remnants ([#470](https://github.com/hieptran87/AionCore/issues/470)) ([eec23d9](https://github.com/hieptran87/AionCore/commit/eec23d9fed25765c43ca9f5f50df91cd53d01888))
* **assistant:** skip dirty assistant bootstrap records ([#615](https://github.com/hieptran87/AionCore/issues/615)) ([f48cbc7](https://github.com/hieptran87/AionCore/commit/f48cbc757f96e3595b00f4f81330dab958f41d28))
* **assistant:** stop legacy override sync from clobbering user toggles ([#634](https://github.com/hieptran87/AionCore/issues/634)) ([346700e](https://github.com/hieptran87/AionCore/commit/346700e1d62470f84eec94b1c58fd3516d1ea90e))
* **auth:** allow same-origin framing on office preview proxy routes ([#454](https://github.com/hieptran87/AionCore/issues/454)) ([3543dbd](https://github.com/hieptran87/AionCore/commit/3543dbdc0b8ca46682b84383d2b6c4aee9bdbdd6))
* **auth:** make AionUi-&gt;AionPro data adoption a one-shot event ([#716](https://github.com/hieptran87/AionCore/issues/716)) ([c9f6f79](https://github.com/hieptran87/AionCore/commit/c9f6f79fa1a15df177e15a8ff990dcb571d2fe4c))
* **auth:** stop CSRF rejecting agy's PreToolUse callback ([#860](https://github.com/hieptran87/AionCore/issues/860)) ([1d91312](https://github.com/hieptran87/AionCore/commit/1d913129d71b2a253f42d9c644d844c3c3213fe7))
* **butler:** correct three breaking field mismatches + update rule to CLI model ([#607](https://github.com/hieptran87/AionCore/issues/607)) ([b02bce6](https://github.com/hieptran87/AionCore/commit/b02bce62e5b7d847960be8d98e9f3b8c8e163e2c))
* channel reply stream cold start ([#366](https://github.com/hieptran87/AionCore/issues/366)) ([b848ddf](https://github.com/hieptran87/AionCore/commit/b848ddff8fe5a973c67ee3c67187c6248d8c7455))
* **channel:** add Zalo login SSE route and register in aionui-app router ([0996abb](https://github.com/hieptran87/AionCore/commit/0996abb918167aff49e53df3474c9f43fba01ae5))
* **channel:** include zalo in builtin plugins status list ([f8c5a0e](https://github.com/hieptran87/AionCore/commit/f8c5a0e7333258509ac85147c400c11781e47334))
* **channel:** quiet WeChat poll log noise with state-transition logging and exponential backoff ([#683](https://github.com/hieptran87/AionCore/issues/683)) ([ea4da55](https://github.com/hieptran87/AionCore/commit/ea4da55a51138d76f0f539db65c165dd634a5517))
* **channel:** resolve PluginCredentials struct initializers and match arms for Zalo ([61b249e](https://github.com/hieptran87/AionCore/commit/61b249e26d0ab29ff154e9a4c08f0a998aaaedbe))
* **channel:** reuse stored credentials when re-enabling a plugin ([#458](https://github.com/hieptran87/AionCore/issues/458)) ([3920c58](https://github.com/hieptran87/AionCore/commit/3920c583db1c6a49d3209f685a8fb510967ca48a))
* **channel:** support flat config payload and token/imei aliases when enabling zalo plugin ([bd862ab](https://github.com/hieptran87/AionCore/commit/bd862abfdd3b55dc962c118b4bf67cfd45d555fb))
* **ci:** restore main migration immutability guard ([7603d44](https://github.com/hieptran87/AionCore/commit/7603d44227f65f3d15e8b447c00c18bddd212314))
* **ci:** restore main migration immutability guard ([32121c2](https://github.com/hieptran87/AionCore/commit/32121c26b0ce572d498bac53ab6a86eedc3bceb4))
* **ci:** validate migrations against latest release ([5e21e3c](https://github.com/hieptran87/AionCore/commit/5e21e3c570705d0b1793d79ab3edc2572c84d610))
* classify missing MCP launcher runtimes ([#387](https://github.com/hieptran87/AionCore/issues/387)) ([fd8c20c](https://github.com/hieptran87/AionCore/commit/fd8c20cc0f6f36805cf5acc1fee3c708296d661a))
* **claude:** three follow-ups to the tool-step labels ([#872](https://github.com/hieptran87/AionCore/issues/872)) ([f8f7174](https://github.com/hieptran87/AionCore/commit/f8f7174f6c768c3653e2f57843b161fa23758266))
* **cli-version:** deliver the version-drift notice, and stop it reading as an error ([#817](https://github.com/hieptran87/AionCore/issues/817)) ([c0e9e9d](https://github.com/hieptran87/AionCore/commit/c0e9e9d44572a588e3ad79b6ac435fbe53f71b99))
* **conversation:** align workspace path availability handling ([#410](https://github.com/hieptran87/AionCore/issues/410)) ([30bc96b](https://github.com/hieptran87/AionCore/commit/30bc96b01632b2107279e81d641dfe020a3af873))
* **conversation:** apply a cancel that arrives while the agent is still building ([#747](https://github.com/hieptran87/AionCore/issues/747)) ([42fc44b](https://github.com/hieptran87/AionCore/commit/42fc44b51867c525759fd89d4efd7713f0c7f445))
* **conversation:** avoid thinking/text segment id collision ([#342](https://github.com/hieptran87/AionCore/issues/342)) ([7aae690](https://github.com/hieptran87/AionCore/commit/7aae690063be683101b7bacc8e916e9d2b990ede))
* **conversation:** derive assistant runtime type from metadata ([#555](https://github.com/hieptran87/AionCore/issues/555)) ([236217d](https://github.com/hieptran87/AionCore/commit/236217d360ff67d0dcba906f287a34b954cb305d))
* **conversation:** partition temp workspaces and logs by date ([#560](https://github.com/hieptran87/AionCore/issues/560)) ([9bb1f33](https://github.com/hieptran87/AionCore/commit/9bb1f333065318c00da73c3a96f7fe92bea38d49))
* **conversation:** rebuild aionrs sessions from persisted runtime permission ([#661](https://github.com/hieptran87/AionCore/issues/661)) ([239c989](https://github.com/hieptran87/AionCore/commit/239c989a09c53ba85bebf714680fc924c8771f06))
* **conversation:** recover dead ACP turns after agent process loss ([#514](https://github.com/hieptran87/AionCore/issues/514)) ([e0ce4f4](https://github.com/hieptran87/AionCore/commit/e0ce4f4b67c44dff196d122216bd81bb42ca9ea9))
* **conversation:** request plaintext thinking from claude, drop blank thought cards ([#731](https://github.com/hieptran87/AionCore/issues/731)) ([9cd4fb9](https://github.com/hieptran87/AionCore/commit/9cd4fb99648c7d624fa3f897b6291fea51b7c034))
* **conversation:** tell the client when a turn is cancelled before its agent exists ([#827](https://github.com/hieptran87/AionCore/issues/827)) ([86eff2f](https://github.com/hieptran87/AionCore/commit/86eff2fa1dff988860aece3d5879bc10618dbb3a))
* **conversation:** unify provider/model resolution across send/cron paths (ELECTRON-1HX, ELECTRON-1HM) ([#326](https://github.com/hieptran87/AionCore/issues/326)) ([71e275a](https://github.com/hieptran87/AionCore/commit/71e275ae3295d88c9da5eacf9f959d4683b4043d))
* **conversation:** upsert streaming tool calls (AIO-30) ([#484](https://github.com/hieptran87/AionCore/issues/484)) ([a0b3737](https://github.com/hieptran87/AionCore/commit/a0b3737bf6a60c6f5483d4112dc4f4f733a9e6fa))
* **cron:** apply custom assistant rules in scheduled runs ([#495](https://github.com/hieptran87/AionCore/issues/495)) ([3840b77](https://github.com/hieptran87/AionCore/commit/3840b77f4f4dc26b58481868507e07e13fb9fbd1))
* **cron:** enforce full-auto mode for scheduled tasks ([#576](https://github.com/hieptran87/AionCore/issues/576)) ([cf0a9bd](https://github.com/hieptran87/AionCore/commit/cf0a9bd88ac295fe8b40a6c1f9f21174b574718d))
* **cron:** lock team cron execution mode ([#562](https://github.com/hieptran87/AionCore/issues/562)) ([56f3873](https://github.com/hieptran87/AionCore/commit/56f38734844164707782b795627a8d65ff1b3c16))
* **cron:** preserve existing conversation jobs across lifecycle changes ([#572](https://github.com/hieptran87/AionCore/issues/572)) ([fa4217a](https://github.com/hieptran87/AionCore/commit/fa4217a6d4ba0cde4d4c7d0d5460969b94eb6c4a))
* **cron:** restore create command heading ([#547](https://github.com/hieptran87/AionCore/issues/547)) ([1a30f77](https://github.com/hieptran87/AionCore/commit/1a30f7710de2c98856f7256811543c1121dddc76))
* **cron:** retry busy jobs from runtime state ([#459](https://github.com/hieptran87/AionCore/issues/459)) ([9918058](https://github.com/hieptran87/AionCore/commit/9918058788e07508ee61fc841e4c85cf757b8bb6))
* **cron:** route skill scheduling through helper ([#553](https://github.com/hieptran87/AionCore/issues/553)) ([c57970f](https://github.com/hieptran87/AionCore/commit/c57970fed387ba895dd934f85c4c59af63da6cfa))
* **cron:** run jobs through conversation service ([#546](https://github.com/hieptran87/AionCore/issues/546)) ([b36fb5c](https://github.com/hieptran87/AionCore/commit/b36fb5c471b19edefd0b63dc2acf3e3d4c2c52ae))
* **cron:** use host timezone for conversation cron ([#652](https://github.com/hieptran87/AionCore/issues/652)) ([19b36f8](https://github.com/hieptran87/AionCore/commit/19b36f8ee3e67b5ffe58a0ca333696a880c22c9b))
* **database:** require explicit corrupted database recovery ([#563](https://github.com/hieptran87/AionCore/issues/563)) ([203bd1b](https://github.com/hieptran87/AionCore/commit/203bd1b574438cf730c351879a773a82548b972c))
* **db:** pre-migration repair for migration-030 startup-blocking CHECK failures ([#724](https://github.com/hieptran87/AionCore/issues/724)) ([859ed7e](https://github.com/hieptran87/AionCore/commit/859ed7e5bdd2da5664b0f1d2df4e2b9cd92aaf3b))
* **db:** prevent duplicate migration versions ([af88855](https://github.com/hieptran87/AionCore/commit/af88855a5e1610797689debd81755136f740cc2d))
* **db:** prevent duplicate migration versions ([39b74ba](https://github.com/hieptran87/AionCore/commit/39b74ba1befeb052a673edaf9f05313c774fc1d7))
* **db:** repair legacy handoff schema drift ([#516](https://github.com/hieptran87/AionCore/issues/516)) ([292e5f2](https://github.com/hieptran87/AionCore/commit/292e5f2d6fc727f41f4164d5f51cfa37c103b060))
* **db:** serialize migrations with fs2 file lock to avoid concurrent race (ELECTRON-1KK) ([#329](https://github.com/hieptran87/AionCore/issues/329)) ([8550851](https://github.com/hieptran87/AionCore/commit/85508518b1df99b48d9ea09f474ed4d64437e8af))
* **db:** widen migration-030 pre-repair gate to any pre-030 start point ([#756](https://github.com/hieptran87/AionCore/issues/756)) ([6e2b33d](https://github.com/hieptran87/AionCore/commit/6e2b33d75bfa0b5c504514fc25d1f09d6db7b3f7))
* **deps:** update quinn-proto for RustSec advisory ([#508](https://github.com/hieptran87/AionCore/issues/508)) ([05df6f7](https://github.com/hieptran87/AionCore/commit/05df6f7c2d924b94d1514bcee4ff835ea0e0b0fb))
* enforce workspace path whitespace errors across create and runtime ([#381](https://github.com/hieptran87/AionCore/issues/381)) ([9448a36](https://github.com/hieptran87/AionCore/commit/9448a36cec456648bd87a680e9dc84083038a63a))
* **engine:** update rust crate getrandom-6f8ce4dd05d13bba to 0.4 ([#212](https://github.com/hieptran87/AionCore/issues/212)) ([0cf059b](https://github.com/hieptran87/AionCore/commit/0cf059b283fcd7d795b0bd6505da7fce3d655a2f))
* **error:** canonicalize boundary errors ([#415](https://github.com/hieptran87/AionCore/issues/415)) ([84e04e1](https://github.com/hieptran87/AionCore/commit/84e04e122dad19eee712af29d3b5bd3f631a6fe1))
* expose managed resource preparation failure details ([#430](https://github.com/hieptran87/AionCore/issues/430)) ([e010024](https://github.com/hieptran87/AionCore/commit/e010024fce3975fe5f6930c24377bde9f636b55b))
* **extension:** fall back to directory copy when Windows symlink fails (Sentry I1) ([#331](https://github.com/hieptran87/AionCore/issues/331)) ([d65a0a1](https://github.com/hieptran87/AionCore/commit/d65a0a13449f0941a68adbeae950f094e2545bfe))
* **file-watch:** degrade gracefully when watcher init fails instead of killing backend ([#751](https://github.com/hieptran87/AionCore/issues/751)) ([bdb6d61](https://github.com/hieptran87/AionCore/commit/bdb6d619c62cd5294bb09248b86b10fc5cd9ba1f))
* **file:** lazy load browse roots ([#406](https://github.com/hieptran87/AionCore/issues/406)) ([668c562](https://github.com/hieptran87/AionCore/commit/668c5623ffd30243cb0ed72e670eecb578fb22cc))
* **file:** strip verbatim \\?\ prefix from non-browse path outputs ([#736](https://github.com/hieptran87/AionCore/issues/736)) ([782ddd0](https://github.com/hieptran87/AionCore/commit/782ddd083074bec1857a3a9b5bc64852ae525c4f))
* **file:** strip Windows verbatim prefix from /api/fs/browse paths ([#453](https://github.com/hieptran87/AionCore/issues/453)) ([f8c3f95](https://github.com/hieptran87/AionCore/commit/f8c3f950f9897c4e13ae7bb1dbb7816017b86480))
* **file:** trust local workspace roots for fs routes ([#527](https://github.com/hieptran87/AionCore/issues/527)) ([8e6f32f](https://github.com/hieptran87/AionCore/commit/8e6f32fe1eda91177d794dca80c87cff3cd970fa))
* handle Hermes yolo fallback correctly ([#428](https://github.com/hieptran87/AionCore/issues/428)) ([e10d264](https://github.com/hieptran87/AionCore/commit/e10d26460ac6dabf292f8b1edd7eeb1c1ffd5cad))
* harden ACP image path handling ([#477](https://github.com/hieptran87/AionCore/issues/477)) ([c79b5a8](https://github.com/hieptran87/AionCore/commit/c79b5a8a010fee82219579873a062bcca5c71fc2))
* harden managed ACP bundle preparation and builtin CLI availability ([#426](https://github.com/hieptran87/AionCore/issues/426)) ([e0121f9](https://github.com/hieptran87/AionCore/commit/e0121f938e0160f48d2f57e9205f78bf31b92233))
* isolate ACP cancel turn completion ([#461](https://github.com/hieptran87/AionCore/issues/461)) ([ea01ee6](https://github.com/hieptran87/AionCore/commit/ea01ee6849d66dad698fee48f6374233d23985ae))
* load skills in custom workspaces ([#506](https://github.com/hieptran87/AionCore/issues/506)) ([d73c398](https://github.com/hieptran87/AionCore/commit/d73c39855c1863e0606aedcb6c4ef8ebffeec8cc))
* **managed-resources:** emit bundled resource manifest ([#617](https://github.com/hieptran87/AionCore/issues/617)) ([64b5062](https://github.com/hieptran87/AionCore/commit/64b506239639c632eb5f6acb4495e58e74c64167))
* **mcp:** clean up stdio test process trees ([#368](https://github.com/hieptran87/AionCore/issues/368)) ([3481956](https://github.com/hieptran87/AionCore/commit/3481956d4c7e2148302d9f31ecef5a88357c38e8))
* **mcp:** support aionrs config path subcommand with legacy fallback ([#568](https://github.com/hieptran87/AionCore/issues/568)) ([72cfba1](https://github.com/hieptran87/AionCore/commit/72cfba1909d663117615a595316804c7707bdfd3))
* **model_fetcher:** extract first key from multi-line api_key for HTTP requests ([#593](https://github.com/hieptran87/AionCore/issues/593)) ([1161647](https://github.com/hieptran87/AionCore/commit/116164756544306ef8ac257106a03e665c85cf3d))
* **office:** fetch officecli installer from official mirror before GitHub ([#463](https://github.com/hieptran87/AionCore/issues/463)) ([08fbc6f](https://github.com/hieptran87/AionCore/commit/08fbc6f12d154d5419ae1b092a1a9352ee64250e))
* **office:** probe star-office preferred_url host as given ([#456](https://github.com/hieptran87/AionCore/issues/456)) ([3c2149c](https://github.com/hieptran87/AionCore/commit/3c2149ca92aad8a0e19fae0d8083083500f60267))
* **office:** resolve officecli shim from node_modules/.bin after npm prefix install ([#440](https://github.com/hieptran87/AionCore/issues/440)) ([2fe76ee](https://github.com/hieptran87/AionCore/commit/2fe76eebbaab1d323b4f81acaff8187a0c00bac7))
* **office:** restore OfficeCLI installer resolution ([#444](https://github.com/hieptran87/AionCore/issues/444)) ([009e133](https://github.com/hieptran87/AionCore/commit/009e133e9e914556a579f27a3671fb5ff47333f7))
* prepare managed acp tools locally without cdn ([#408](https://github.com/hieptran87/AionCore/issues/408)) ([2a48ae3](https://github.com/hieptran87/AionCore/commit/2a48ae34a498ff0e5bd37d0eedee81d2ea7d0154))
* preserve ACP config catalogs on resume ([#570](https://github.com/hieptran87/AionCore/issues/570)) ([a9c1955](https://github.com/hieptran87/AionCore/commit/a9c19553bad1da3283f5dfad1972cd1ed1992546))
* preserve assistant snapshot and skill wiring for cron ([#473](https://github.com/hieptran87/AionCore/issues/473)) ([2d47d8c](https://github.com/hieptran87/AionCore/commit/2d47d8cca71c4d0fdc3d1c2b93916c03b8c3b42c))
* preserve cron timezone on legacy schedule updates ([#344](https://github.com/hieptran87/AionCore/issues/344)) ([6328b76](https://github.com/hieptran87/AionCore/commit/6328b7683133a6f74e87add6c11386ebbb0dad49))
* preserve Linux GLIBC baselines ([#573](https://github.com/hieptran87/AionCore/issues/573)) ([ab6e227](https://github.com/hieptran87/AionCore/commit/ab6e227504c40f78823988d4c10af8fd153cc47c))
* prevent silent encryption-key rotation on migration upgrade (ELECTRON-3T0) ([#722](https://github.com/hieptran87/AionCore/issues/722)) ([4993fe8](https://github.com/hieptran87/AionCore/commit/4993fe858c531f6b2ca471ad59612d46e97d9de9))
* **process:** allow whitespace in workspace cwd segments ([#410](https://github.com/hieptran87/AionCore/issues/410) parity) ([#674](https://github.com/hieptran87/AionCore/issues/674)) ([c344b02](https://github.com/hieptran87/AionCore/commit/c344b028edf291b30d17d0a823bdab5ca74efe1f))
* **process:** reap tool subprocesses that left the process group ([#753](https://github.com/hieptran87/AionCore/issues/753)) ([7bc0260](https://github.com/hieptran87/AionCore/commit/7bc026006c55a7f38d94f86a44af6d36105284b3))
* **project/monitor:** attribute watched-subdir events to parent so tree reflects dir delete/rename ([#734](https://github.com/hieptran87/AionCore/issues/734)) ([8494a1f](https://github.com/hieptran87/AionCore/commit/8494a1f95f7c8c08f85b1d30d2d39c99770325a5))
* **project:** add temporary fs/resolve command for preview file paths ([#723](https://github.com/hieptran87/AionCore/issues/723)) ([575feac](https://github.com/hieptran87/AionCore/commit/575feacd9e5aef7b7948a882bdb9ce27050e2829))
* **project:** emit real-case absolute path to agents, not folded canonical ([#809](https://github.com/hieptran87/AionCore/issues/809)) ([f0f4fbd](https://github.com/hieptran87/AionCore/commit/f0f4fbd1234a039861f2b3e857cd821337c37672))
* **provider:** preserve automatic vision detection ([08696fd](https://github.com/hieptran87/AionCore/commit/08696fd0b46794497c7bf70473874753a66c1925))
* **realtime:** forward id and read nested data in subscribe-show-open ([#323](https://github.com/hieptran87/AionCore/issues/323)) ([7dc222f](https://github.com/hieptran87/AionCore/commit/7dc222fd444e3869e7b44101fa709e4704ad0a7e))
* recover deleted conversation workspaces ([#379](https://github.com/hieptran87/AionCore/issues/379)) ([759afb8](https://github.com/hieptran87/AionCore/commit/759afb88ed404a055abd686c427e5805161b812b))
* repair invalid UTF-8 agent metadata cache fields ([#526](https://github.com/hieptran87/AionCore/issues/526)) ([91969cd](https://github.com/hieptran87/AionCore/commit/91969cd765dbecf962ba3c986eb271dfc8208c0b))
* resolve ACP backends from metadata ([#559](https://github.com/hieptran87/AionCore/issues/559)) ([6c15bb7](https://github.com/hieptran87/AionCore/commit/6c15bb765f8c84baddd89830839c832424ef1789))
* restore direct CLI Team MCP capabilities ([#853](https://github.com/hieptran87/AionCore/issues/853)) ([fe99ff6](https://github.com/hieptran87/AionCore/commit/fe99ff6051cf5d0a766332e56ffa66e9d8c61234))
* **runtime:** add bounded retry to managed node version probe ([#771](https://github.com/hieptran87/AionCore/issues/771)) ([1dee9f1](https://github.com/hieptran87/AionCore/commit/1dee9f1e961a529f7aae701f97ddb1deeab64655))
* **runtime:** find agent CLIs installed by bun and by vendor installers ([#856](https://github.com/hieptran87/AionCore/issues/856)) ([8881980](https://github.com/hieptran87/AionCore/commit/8881980401da402eaa6ecf73e884c104635b34ff))
* **runtime:** harden managed Node command resolution ([#565](https://github.com/hieptran87/AionCore/issues/565)) ([e69b83a](https://github.com/hieptran87/AionCore/commit/e69b83a836b369b4244a04b64f931bea1dd54743))
* **runtime:** protect active ACP tasks from idle cleanup ([#561](https://github.com/hieptran87/AionCore/issues/561)) ([1fa7a54](https://github.com/hieptran87/AionCore/commit/1fa7a543e8fd4cec7e423443cbd6299de6a761ad))
* **runtime:** report bundled resource installation failures ([#420](https://github.com/hieptran87/AionCore/issues/420)) ([bc4b7d9](https://github.com/hieptran87/AionCore/commit/bc4b7d9315727b1e4fe00cb54c1230828dd37cf1))
* **runtime:** retry transient bundled-node activation copy and reclassify persistent I/O failures ([#760](https://github.com/hieptran87/AionCore/issues/760)) ([23d2ec6](https://github.com/hieptran87/AionCore/commit/23d2ec658dd3dfda89156f7119945ac3c7141611))
* **runtime:** update Claude ACP package ([#599](https://github.com/hieptran87/AionCore/issues/599)) ([cf69332](https://github.com/hieptran87/AionCore/commit/cf693323913c31d3276a5e103b434c6ca51b519e))
* **runtime:** update managed Codex ACP package ([#598](https://github.com/hieptran87/AionCore/issues/598)) ([1bb2be7](https://github.com/hieptran87/AionCore/commit/1bb2be72a040d16f284d4a0b5b2de670aa2f864b))
* scope bundled ACP output under tool directories ([#431](https://github.com/hieptran87/AionCore/issues/431)) ([d079395](https://github.com/hieptran87/AionCore/commit/d079395b0679d5b9450497a4d088bc478c5cf45f))
* **server:** emit AIONCORE_READY marker once serving begins ([#761](https://github.com/hieptran87/AionCore/issues/761)) ([8b08130](https://github.com/hieptran87/AionCore/commit/8b08130365ec7c883736c0b4aabcef471002dd7b))
* **session:** carry tool input on permission events so the approval card shows what is being approved ([#715](https://github.com/hieptran87/AionCore/issues/715)) ([bdbb11c](https://github.com/hieptran87/AionCore/commit/bdbb11c7f32547996fe6e33b0a4d8b833cb7279b))
* **session:** force-kill direct-CLI turns on UserCancelTimeout ([#702](https://github.com/hieptran87/AionCore/issues/702)) ([34119ce](https://github.com/hieptran87/AionCore/commit/34119ce01ff6702be7428dfc33aba79add160fac))
* **session:** keep claude session cost cumulative across process respawns ([#767](https://github.com/hieptran87/AionCore/issues/767)) ([f498e9d](https://github.com/hieptran87/AionCore/commit/f498e9d2deb57d3491d5a107b622d24d5c8df7df))
* **session:** preserve codex's real error when systemError precedes the terminal ([#694](https://github.com/hieptran87/AionCore/issues/694)) ([994e3fe](https://github.com/hieptran87/AionCore/commit/994e3fe27c9c673e28cda2de23828501066af04b))
* **session:** restore codex slash commands + recover dead resume anchors on the direct-CLI path ([#679](https://github.com/hieptran87/AionCore/issues/679)) ([7b60611](https://github.com/hieptran87/AionCore/commit/7b606113c36051d533f4463849060c4be8310552))
* **session:** retry claude session-title generation with timeout and observability ([#843](https://github.com/hieptran87/AionCore/issues/843)) ([c59e937](https://github.com/hieptran87/AionCore/commit/c59e937a0cc49327a6756c32fb77213e1abe2224))
* **session:** settle cancelled workflows and stop per-turn pump state leaking across turns ([#732](https://github.com/hieptran87/AionCore/issues/732)) ([b8a4a88](https://github.com/hieptran87/AionCore/commit/b8a4a882f50838d2e26211a2f3f8713a0eded1b9))
* **session:** settle cards through teardown and resume so no stored row spins forever ([#766](https://github.com/hieptran87/AionCore/issues/766)) ([3f61cc4](https://github.com/hieptran87/AionCore/commit/3f61cc490ec589f6602eeeb30487443cd9d1061e))
* **session:** stop reporting still-running codex commands as cancelled ([#783](https://github.com/hieptran87/AionCore/issues/783)) ([a326fb2](https://github.com/hieptran87/AionCore/commit/a326fb260905c82961ca9730461f872068ccb255))
* **shell:** reveal file via FileManager1 D-Bus on Linux ([#466](https://github.com/hieptran87/AionCore/issues/466)) ([98c75ec](https://github.com/hieptran87/AionCore/commit/98c75ecc1bf20263f9bb682d8729d0924060f178))
* **shell:** support UNC paths in Windows terminal ([#411](https://github.com/hieptran87/AionCore/issues/411)) ([a041953](https://github.com/hieptran87/AionCore/commit/a04195329996b921cee811066994efb885b833e1))
* **skill:** raise import size limits ([#564](https://github.com/hieptran87/AionCore/issues/564)) ([50d9aff](https://github.com/hieptran87/AionCore/commit/50d9affe53ad64e994564a31215caab428eb7094))
* **skills:** correct AionUi Butler skill drift against current backend ([#557](https://github.com/hieptran87/AionCore/issues/557)) ([41c2c94](https://github.com/hieptran87/AionCore/commit/41c2c9426eefb2ce29de4a9f5b4e10c862a63994))
* **skills:** correct aionui-config butler skill drift (2026-07) ([#584](https://github.com/hieptran87/AionCore/issues/584)) ([e72e03f](https://github.com/hieptran87/AionCore/commit/e72e03ff6e1366f705352bcefec474887a85adfa))
* **skills:** repair butler cron and doc drift (2026-07-22 audit) ([#664](https://github.com/hieptran87/AionCore/issues/664)) ([273ac47](https://github.com/hieptran87/AionCore/commit/273ac476bc892edb7bb63429e423e0b4928bcad0))
* **skills:** repair butler endpoint drift + add cron scheduling ([#550](https://github.com/hieptran87/AionCore/issues/550)) ([88bcff3](https://github.com/hieptran87/AionCore/commit/88bcff3c08ebcd5e5dff8f16ba9c68fa313ef55f))
* **skills:** sync AionUi Butler skills + rule with current backend ([#520](https://github.com/hieptran87/AionCore/issues/520)) ([5603b9a](https://github.com/hieptran87/AionCore/commit/5603b9a77857b08d99d45c02eeeeb4d6d1e1e98a))
* split streamed message segments around tool boundaries ([#339](https://github.com/hieptran87/AionCore/issues/339)) ([476b1cc](https://github.com/hieptran87/AionCore/commit/476b1cc86f2adef8998477a666809dda50afca3e))
* **startup:** add backend readiness diagnostics ([#346](https://github.com/hieptran87/AionCore/issues/346)) ([ae8e01c](https://github.com/hieptran87/AionCore/commit/ae8e01c927118779bbad64da42a6b81aef27e9c9))
* **startup:** add startup phase diagnostics ([#388](https://github.com/hieptran87/AionCore/issues/388)) ([d24d027](https://github.com/hieptran87/AionCore/commit/d24d02726e03b852c8ee87caa872ed1605509143))
* **startup:** make concurrent aioncore startup safe over one data directory ([#657](https://github.com/hieptran87/AionCore/issues/657)) ([2a64b55](https://github.com/hieptran87/AionCore/commit/2a64b55e1ab52f789dcb3a715ef0a940b35a20b3))
* stop defaulting aionrs max tokens ([22bc24b](https://github.com/hieptran87/AionCore/commit/22bc24b1f30ef4d475ccada7d36b3ee977054eba))
* **stt:** STT compatibility fixes for Groq Whisper and AionUI web frontend ([#400](https://github.com/hieptran87/AionCore/issues/400)) ([4c3fa09](https://github.com/hieptran87/AionCore/commit/4c3fa094087c8479d0c2975ec896ce46fb37abca))
* **stt:** treat blank base_url as unset and log malformed config ([#448](https://github.com/hieptran87/AionCore/issues/448)) ([f6b653b](https://github.com/hieptran87/AionCore/commit/f6b653bbdd5822dcd1b52790f0cf28db65115011))
* **system:** apply keep-awake client preference ([#642](https://github.com/hieptran87/AionCore/issues/642)) ([a6a290d](https://github.com/hieptran87/AionCore/commit/a6a290dd374a37eca73fc008c25bd6780a0e1f54))
* **system:** release keep-awake on shutdown ([#666](https://github.com/hieptran87/AionCore/issues/666)) ([6e0b3a7](https://github.com/hieptran87/AionCore/commit/6e0b3a73a6bc8fca6f7c5378760d352bfe6e667c))
* **team-mcp:** use fixed server name to stay within 64-char tool limit (ELECTRON-1JY) ([#336](https://github.com/hieptran87/AionCore/issues/336)) ([eaa3aa0](https://github.com/hieptran87/AionCore/commit/eaa3aa098816191d8531ef0f1de12292e5e47cc5))
* **team:** broadcast Stopped status on idle-cleanup team reclaim ([#640](https://github.com/hieptran87/AionCore/issues/640)) ([024a3a5](https://github.com/hieptran87/AionCore/commit/024a3a578936af0c59ed5aeed7bc1b4c20d990ea))
* **team:** converge run-scoped wakes into a run at the enqueue choke-point ([#690](https://github.com/hieptran87/AionCore/issues/690)) ([c6fdcde](https://github.com/hieptran87/AionCore/commit/c6fdcde549c9ebcd0aa91c018758b8bea960ea70))
* **team:** converge system/lifecycle wakes into a team run ([#680](https://github.com/hieptran87/AionCore/issues/680)) ([38facd7](https://github.com/hieptran87/AionCore/commit/38facd70868fe25135b01fd6e276dc816abddc05))
* **team:** derive team capability from probed MCP transports, not a stored veto ([#725](https://github.com/hieptran87/AionCore/issues/725)) ([d60fc62](https://github.com/hieptran87/AionCore/commit/d60fc6297c3477658f4cdc635f6de7540230d28f))
* **team:** dispatch native slash commands as bare command turns ([#696](https://github.com/hieptran87/AionCore/issues/696)) ([45d4e71](https://github.com/hieptran87/AionCore/commit/45d4e715e34749b75f9ba671f59e98766e2ed14d))
* **team:** inherit workspace for spawned agents ([#413](https://github.com/hieptran87/AionCore/issues/413)) ([82b31c5](https://github.com/hieptran87/AionCore/commit/82b31c5fbdb1e30a580865b4c441b1ac93ec5181))
* **team:** retry handoff turns after runtime release ([#480](https://github.com/hieptran87/AionCore/issues/480)) ([77d252f](https://github.com/hieptran87/AionCore/commit/77d252fdd7e43c740043bc3f7963a06a1461fec8))
* use provider and model protocol to determine llm request. ([37f76a8](https://github.com/hieptran87/AionCore/commit/37f76a8bf1ba8aafabb5dd6b6062da40173ef010))
* validate managed ACP packages via real entrypoints ([#429](https://github.com/hieptran87/AionCore/issues/429)) ([77221dd](https://github.com/hieptran87/AionCore/commit/77221ddddd883c56b954ca5cfea0f98038754efe))
* validate skill frontmatter as yaml ([#512](https://github.com/hieptran87/AionCore/issues/512)) ([6b46055](https://github.com/hieptran87/AionCore/commit/6b460552b63cdb6242703831c25443d9153fc25e))
* **windows:** handle runtime process lifecycle ([399f920](https://github.com/hieptran87/AionCore/commit/399f920c31ab4d738ffa32b5ebcff9416ba44e6f))


### Code Refactoring

* **acp:** upgrade agent-client-protocol SDK 0.11.1 -&gt; 2.0.0 ([#708](https://github.com/hieptran87/AionCore/issues/708)) ([9e185f0](https://github.com/hieptran87/AionCore/commit/9e185f0b196e6945b4d716553968150cb162c7ba))
* **app:** organize CLI command boundaries ([#423](https://github.com/hieptran87/AionCore/issues/423)) ([cc84d52](https://github.com/hieptran87/AionCore/commit/cc84d523f1014978b0fb9c880842d4fd29330925))
* **assistant:** finalize unified governance storage ([#449](https://github.com/hieptran87/AionCore/issues/449)) ([aba2d2a](https://github.com/hieptran87/AionCore/commit/aba2d2acc0a855152ae372c04b4249e956fc4cbf))
* centralize agent runtime session context building ([#419](https://github.com/hieptran87/AionCore/issues/419)) ([b21f833](https://github.com/hieptran87/AionCore/commit/b21f8334e2955c73be4acb2beb76c79133e2120a))
* centralize runtime turn lifecycle ([#421](https://github.com/hieptran87/AionCore/issues/421)) ([282c68c](https://github.com/hieptran87/AionCore/commit/282c68cb43a6c06862ee61c7441a9dd52a3008b7))
* **error:** finish ApiError phase3 ([#398](https://github.com/hieptran87/AionCore/issues/398)) ([37523ab](https://github.com/hieptran87/AionCore/commit/37523ab628abdfaa29eaf5b0b713cb2251062146))
* **error:** migrate phase2 service errors ([#395](https://github.com/hieptran87/AionCore/issues/395)) ([c6c42ee](https://github.com/hieptran87/AionCore/commit/c6c42eea051083c94eb822163149de6fef2387a3))
* four-layer architecture (connect / conv / biz) ([#349](https://github.com/hieptran87/AionCore/issues/349)) ([2a11285](https://github.com/hieptran87/AionCore/commit/2a11285e316ffc7f0076d385dad8e09a4af2de4b))
* **runtime:** remove legacy Bun runtime support ([#623](https://github.com/hieptran87/AionCore/issues/623)) ([01b5eed](https://github.com/hieptran87/AionCore/commit/01b5eed0db886e05b652c4633c9acd337087e1ab))
* **session:** run the user's own claude/codex, with one shared version-drift path ([#799](https://github.com/hieptran87/AionCore/issues/799)) ([ae817e3](https://github.com/hieptran87/AionCore/commit/ae817e32d7f7f24246fcb0001e334a344d59f351))


### Documentation

* clarify production logging guidance ([#460](https://github.com/hieptran87/AionCore/issues/460)) ([118ed03](https://github.com/hieptran87/AionCore/commit/118ed03b5393ec87edf8801ed7395d917c87855a))
* de-stale AGENTS.md and guard against symbol-anchored rules ([#649](https://github.com/hieptran87/AionCore/issues/649)) ([9bd188c](https://github.com/hieptran87/AionCore/commit/9bd188cd89990413bc9e70cc9392ac1a1c5fdc91))
* refresh architecture crate catalog ([#791](https://github.com/hieptran87/AionCore/issues/791)) ([4d59a21](https://github.com/hieptran87/AionCore/commit/4d59a21aaa0b4ff8210e04cea41872920a2f8a65))
* **skills:** add cross-platform notes so Windows users translate shell examples ([#489](https://github.com/hieptran87/AionCore/issues/489)) ([e03b030](https://github.com/hieptran87/AionCore/commit/e03b0309c9fcd4914175d22787efa90e9599c8ec))
